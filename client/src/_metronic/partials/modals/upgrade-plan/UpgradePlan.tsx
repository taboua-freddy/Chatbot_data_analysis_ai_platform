                                                    ...
                                                    <div className='d-flex align-items-center me-2'>
                                                        ...
                                                        <div className='flex-grow-1'>
                                                            <h2 className='d-flex align-items-center fs-2 fw-bolder flex-wrap'>
                                                                ...
                                                                {plan.label && (
                                                                    <span
                                                                        className='badge badge-light-success ms-2 fs-7'>
                                    {plan.label}
                                  </span>
                                                                )}
                                                            </h2>
                                                    ...
                                                    <div className='ms-5'>
                                                        {plan.custom && (
                                                            <button className='btn btn-sm btn-primary'>Contact
                                                                Us</button>
                                                        )}
                                                        {!plan.custom && (
                                                            <>
                                                ...
                                                <div key={`custom${index}`}>
                                                    {!plan.custom && (
                                                        <>
                                                            ...
                                                            >
                                                                <div className='pb-5'>
                                                                    <h2 className='fw-bolder text-dark'>What’s in
                                                                        Startup Plan?</h2>

                                                                    <div
                                                                        className='text-gray-400 fw-bold'>{plan.description}</div>
                                                                </div>
